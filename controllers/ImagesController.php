...
class ImagesController extends Controller
{
    ...
    public function actionIndex($id)
    {
        ...
        $merchantmodel = Products::findOne($id);
                ...
                if ($tmpFilePath != "") {
                    ...
                    if (in_array($ext, $allwoedFiles)){
                        ...
                        if (move_uploaded_file($tmpFilePath, 'uploads/products/' . $newFileName)) {
                            ...
                            $productsImages->product_id = $products_id;
                            $productsImages->image = 'uploads/products/' . $newFileName;
                            $productsImages->created_at = date('Y-m-d h:i:s');
                            $productsImages->save();
                            $files['initialPreview'] = \yii\helpers\Url::base(TRUE) . '/uploads/products/' . $newFileName;
