...
class UsersSearch extends Users
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'role', 'full_name', 'contact_no', 'country','email', 'hp_no', 'bank_account_name', 'bank_account_no', 'bank_name', 'image', 'password', 'secondary_password', 'token', 'verify_token', 'reset_token', 'firebase_token', 'device_token', 'created_at', 'updated_at','membership_level','company_name'], 'safe'],
    ...
    {
        $query = Users::find()->where(['role'=>'Seller']);
    ...
    {
        $query = Users::find()->where(['role'=>'Buyer']);
